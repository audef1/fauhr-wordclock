...
void loop()
{
  ...
  // Minutes exactly 0 - "JUSTE"
  if ((m==0)){
    individualPixels[28]=1; // J
    individualPixels[29]=1; // U
    individualPixels[30]=1; // S
    individualPixels[31]=1; // T
    individualPixels[32]=1; // E
  }
  ...
  // Minutes between 10-15 or 50-55 - "ZÄ"
  ...
  if (h==2 || h==14){
    ...
    individualPixels[49]=1; // Ü
    individualPixels[50]=1; // Ü
  }
  
  // Hour=3 - "DRÜÜ"
  if (h==3 || h==15){
    individualPixels[51]=1; // D
    individualPixels[52]=1; // R
    individualPixels[53]=1; // Ü
  ...
  if (h==5 || h==17){
    ...
    individualPixels[58]=1; // Ü
    individualPixels[57]=1; // f
    individualPixels[56]=1; // I
  }
  ...
  if (h==10 || h==22){
    ...
    individualPixels[90]=1; // C
    individualPixels[91]=1; // H
    individualPixels[92]=1; // N
    individualPixels[93]=1; // N
  }
  
  // Hour=11 - "ÖUFI"
  if (h==11 || h==23){
    individualPixels[95]=1; // Ö
